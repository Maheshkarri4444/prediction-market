  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled && daoAcc?.daoTotalStake) {
          setDaoTotalStake(daoAcc.daoTotalStake);
        }
      } catch (e) {
        // DAO may not be initialized — silently ignore
      }
    })();
...
export default function PredictionMarketPlace() {
  ...
  // ── Fetch DAO total stake for quorum checks ──────────────────────────────
